  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        <input style={{ width: '100%' }} value={easing} onChange={(e) => setEasing(e.target.value)} />
      </div>

      <button onClick={startAnimation}>Play Animation</button>

      <div style={{ marginTop: '2rem', border: '1px solid #444', padding: '1rem', backgroundColor: '#1a1a1a', height: '100px' }}>
        <div 
          className="box" 
          style={{ 
